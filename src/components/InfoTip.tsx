...
import { depthTier } from './ui/Surface';
  ...
  return (
    <span className="group relative inline-flex align-middle">
      ...
      <span
        ...
        className={`pointer-events-none absolute top-6 z-40 w-[min(16rem,calc(100vw-2rem))] select-none rounded-[var(--radius-control)] bg-ink px-3 py-2 text-xs font-normal leading-relaxed text-surface opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100 max-sm:right-0 sm:left-1/2 sm:-translate-x-1/2 ${depthTier('overlay')}`}
      >
        {label}
      </span>
    </span>
