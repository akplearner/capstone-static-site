  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex overflow-hidden rounded-lg depth-edge">
          <button
        ...
        {onDensityChange && (
          <div className="flex overflow-hidden rounded-lg depth-edge" role="group" aria-label="How much to show">
            <button
              type="button"
          ...
          <div className="space-y-3 py-1 pr-2">
            ...
            <div className="flex flex-wrap items-center gap-2 border-t border-line pt-3">
              {allDone ? (
                <button
                  onClick={undoAll}
                  className="flex items-center gap-1 rounded-lg depth-edge px-3 py-1.5 text-xs font-medium text-muted hover:bg-panel-2"
                >
      ...
      {task.steps.some((s) => s.command || s.commands?.length) && (
        <div className="rounded-lg depth-edge bg-panel-2/50 px-3">
