...
export const SERVER_PLUS_DELIVERABLES: DeliverableDef[] = [
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { field: 'acceptance', label: 'Acceptance criteria (the four milestones)', type: 'area', required: true, placeholder: 'Wk1 racked & cabled · Wk2 platform installed · Wk3 configured & patched · Wk4 protected & handed over' },
        ],
      },
    ],
    dod: [
  ...
  // 3 — Asset Register / CMDB ────────────────────────────────────────────────
  {
    ...
    buildSteps: [
      ...
      'Complete the software tab in Week 3, once every service is installed.',
    ],
    meaning:
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { field: 'diagram_file', label: 'Topology diagram file', type: 'text', placeholder: 'GranitePeak_Wk2_topology.png' },
        ],
      },
      {
        kind: 'group',
