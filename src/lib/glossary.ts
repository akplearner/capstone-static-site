...
export const GLOSSARY: Record<string, string> = {
  ...
  drift: 'Reality diverging from what the code says — a change made in the console instead of the repository. terraform plan detects it; the next apply may undo it.',
