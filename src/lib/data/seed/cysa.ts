  ...
  // ─────────────────────────── WEEK 1 · DEPLOY ───────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        whatItMeans: 'The agent ships your host logs to the SOC; the Suricata block adds the network alerts to the same feed.',
      ...
      },
      {
        ...
        whatItMeans: 'Windows telemetry now lands in the same dashboard as your Ubuntu logs and Suricata alerts.',
        expectedOutput: 'Windows Services shows Wazuh as Running (or `Get-Service WazuhSvc` prints Running). No firewall step here — Windows Defender Firewall is already on; UFW is Linux-only.',
        verify: ['Running'],
        files: [
        ...
        frameworks: ['NIST_CSF'],
        troubleshooting: 'Agent never appears at the SOC? Two agents with the same name is the most common cause — make the name unique (Team<#>-win). Also confirm the PC can reach 10.10.100.100 on ports 1514/1515 and that WazuhSvc is Running (NET START WazuhSvc).',
      },
    ],
  },
  {
