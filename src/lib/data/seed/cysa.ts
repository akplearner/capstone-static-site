  ...
  // ─────────────────────────── WEEK 0 · Lab & SOC build (builder) ───────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        files: [
          { name: 'wazuh-install.sh (v4.14)', purpose: 'the all-in-one installer for manager + indexer + dashboard', source: 'curl -sO https://packages.wazuh.com/4.14/wazuh-install.sh' },
        ],
