...
+ 1 host(s) tested`,
      ...
      },
      {
        ...
        instruction: 'In your notes, build a comparison table with one row per service and six columns: service/port · nmap version · Wazuh package version · agree? · which source you trust · why.',
        instructionList: [
          'The nmap version comes from your -sV output; the Wazuh package version comes from the Vulnerabilities module.',
          'The two sources differ because Wazuh reads the installed package version while nmap reads the live service banner.',
          'Example row: 80/http · Apache httpd 2.4.41 · apache2 2.4.41-4ubuntu3 · yes · either · versions match.',
          'Hand the finished table to the Incident Responder.',
        ],
