...
const tasks: Task[] = [
  ...
  // ─────────────────────────── WEEK 1 · DEPLOY ───────────────────────────
  {
    ...
    prerequisites: ['The SOC is up at http://10.10.100.100 (sign in: student / @Pass@2026)', 'You can SSH into your Ubuntu pod as the `student` user', 'Your team’s pod IPs (set them in the Lab access panel)'],
    ...
    steps: [
      {
        ...
        description: 'Confirm the manager IP the agent reports to: 10.10.100.100.',
      ...
      },
      {
        ...
        description: 'The official Wazuh agent install, pointed at your SOC.',
