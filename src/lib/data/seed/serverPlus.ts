    ...
    steps: [
      {
        ...
        instructionList: [
          ...
          'Address your own extra VMs from 192.168.0.5 upward in the private zone, or 172.16.0.11 upward in the DMZ — .1 to .4 and 172.16.0.10 are already spoken for.',
    ...
    steps: [
      {
        ...
        instructionList: [
          ...
          'Flip the elevation rows from Planned to Installed, log any deviation in the Change Log, and photograph the front and rear of the rack.',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: 'Create all three VMs from the wizard and note the VM ID each one is assigned — every qm command in Weeks 3 and 4 addresses a VM by that number. Record the three IDs in the Configuration Management Record as you go.',
        instructionList: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        where: 'The Configuration Management Record, then the Asset Register',
    ...
    steps: [
      ...
      },
      {
        ...
        instructionList: [
          ...
          'Record the account name and the firewall decision in the Configuration Management Record, and log the change with its rollback.',
        ],
        commands: [
...
export const SERVER_PLUS: Course = {
  ...
  description:
    'Run a real server engagement in about two hours a week — three in the build week. Plan like a sysadmin — business requirements, a 24U rack plan, a hardware audit, an upgrade plan — then build and deploy the platform, network and connect it, and secure it with a proven restore and a PDF handover.',
  roles,
  weeks,
  gates,
  tasks,
